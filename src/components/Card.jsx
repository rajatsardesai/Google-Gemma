const Card = ({ cardIcon, iconAlt, cardTitle, cardDescription }) => {
    return (
        <div className="flex flex-col justify-center items-center w-52 h-52 text-center p-4 bg-color-gray-100 hover:bg-color-gray-200 rounded-[20px] cursor-pointer">
